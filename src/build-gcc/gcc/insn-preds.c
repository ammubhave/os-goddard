...
#line 23 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == REG) && (
#line 28 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == REG) && (!(
#line 33 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
(ANY_FP_REGNO_P (REGNO (op)))))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return ((GET_CODE (op) == REG) && (!(
#line 38 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
(STACK_REGNO_P (REGNO (op)))))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return ((GET_CODE (op) == REG) && (
#line 43 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == REG) && (
#line 48 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
...
#line 53 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
{
...
#line 62 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
{
...
{
  return ((GET_CODE (op) == REG) && (
#line 77 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
(REGNO (op) == AX_REG))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return ((GET_CODE (op) == REG) && (
#line 82 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
(REGNO (op) == FLAGS_REG))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return (
#line 86 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
(QI_REG_P (op))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return ((GET_CODE (op) == REG) && ((
#line 92 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
(TARGET_64BIT)) && (
#line 93 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
(REGNO (op) > BX_REG)))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
#line 98 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
{
  if (!TARGET_64BIT)
...
#line 224 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
{
  switch (GET_CODE (op))
    {
    case CONST_DOUBLE:
...
{
  return (
#line 309 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
...
{
  return (
#line 318 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
(TARGET_64BIT)) ? ((nonimmediate_operand (op, mode)) || ((x86_64_zext_immediate_operand (op, mode)) && (
#line 321 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
...
{
  return (
#line 327 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
...
{
  return (
#line 335 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
...
{
  return (
#line 342 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
...
#line 352 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
{
  if (!flag_pic)
    return false;
...
#line 380 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
{
  switch (GET_CODE (op))
    {
    case SYMBOL_REF:
...
#line 424 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
{
...
{
  return (!(
#line 463 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
...
#line 469 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
...
#line 492 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
{
  if (GET_CODE (op) == SUBREG)
    op = SUBREG_REG (op);
...
#line 506 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
{
  if (GET_CODE (op) == SUBREG)
    op = SUBREG_REG (op);
...
#line 519 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
{
  if (GET_CODE (op) == SUBREG)
    op = SUBREG_REG (op);
...
{
  return (register_operand (op, mode)) || ((!(
#line 543 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
...
{
  return (
#line 549 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
(constant_call_address_operand
		     (op, mode == VOIDmode ? mode : Pmode))) || ((call_register_no_elim_operand (op, mode)) || ((!(
#line 552 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
(TARGET_X32))) && (memory_operand (op, mode))));
}
...
{
  return (
#line 557 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
(constant_call_address_operand
...
#line 564 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
{
  if (mode == VOIDmode)
    mode = GET_MODE (op);
...
#line 573 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
{
  if (mode == VOIDmode)
    mode = GET_MODE (op);
...
#line 582 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
(INTVAL (op) == 8));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 587 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
(INTVAL (op) == 128));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 592 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
...
#line 598 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
{
...
#line 606 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT i = INTVAL (op);
...
#line 614 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT i = INTVAL (op);
  return i == 3 || i == 5 || i == 9;
}
...
{
  return (GET_CODE (op) == CONST_INT) && ((
#line 622 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
(op == const0_rtx)) || (
#line 623 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
(op == const1_rtx)));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 628 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 633 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 638 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 643 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 648 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 667 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 673 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 678 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 683 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 688 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 693 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 698 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 703 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
(IN_RANGE (INTVAL (op), 12, 15)));
}

static inline int
incdec_operand_1 (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
#line 708 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
{
...
#line 720 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
(op == const1_rtx)) || (
#line 721 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
(op == constm1_rtx))));
}
...
{
  return (
#line 725 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
...
{
  return (
#line 730 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
...
#line 738 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
{
  unsigned n_elts;
...
#line 759 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
{
...
#line 792 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
{
...
#line 810 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
{
...
#line 827 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
  rtx disp;
...
#line 871 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 932 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 944 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 964 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 1038 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
...
#line 1053 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
{
  enum machine_mode inmode = GET_MODE (XEXP (op, 0));
  enum rtx_code code = GET_CODE (op);
...
#line 1090 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
{
  enum machine_mode inmode = GET_MODE (XEXP (op, 0));
  enum rtx_code code = GET_CODE (op);
...
{
  return (
#line 1116 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
...
#line 1124 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
{
  enum rtx_code code = GET_CODE (op);
  bool ret;
...
#line 1174 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == MEM) && (
#line 1185 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
...
#line 1190 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
{
  unsigned i;
...
#line 1220 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
{
...
#line 1243 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
...
#line 1250 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
{
...
#line 1265 "../../gcc-4.8.2/gcc/config/i386/predicates.md"
{
